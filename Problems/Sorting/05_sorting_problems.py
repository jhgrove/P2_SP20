...
print(my_list3[0][1], "-", my_list3[0][0], "three pointers.\n")
...
print(my_list4[0][1], "-", my_list4[0][0], "WS/48.\n")
...
print(my_list5[0][2], "-", my_list5[0][1], "three pointers at age", my_list5[0][0] + ".\n")
...
print(my_list6_2[-1][1], "-", my_list6_2[-1][2], "- worst free throw percentage.")
print(my_list6_2[0][1], "-", my_list6_2[0][2], "- best free throw percentage.")
