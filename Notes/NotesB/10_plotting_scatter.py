...
firearms_100 = []
countries = []
similar = ["Canada", "England and Wales", "Japan", "South Korea", "France", "Germany", "Switzerland", "Ireland",
           "China", "Singapore", "Hungary", "Israel", "Taiwan", "Iceland", "Spain", "Belgium", "Finland", "Netherlands",
           "United States"]
